...
| C10 | A **declared attack** routes to real combat resolution | H-30/H-32/H-43/H-48/H-55/H-64/H-71/H-72, **H-92** | playloop attack gates + `go for`/flip-onto-person/npc-generic/firebolt + attack-resolution-over-meta + inanimate-practice-target guard (swing "at the post/dummy" ≠ NPC attack) + `isNaturalWeaponAttack` (bite/maul resolves as a strike, not table-talk; C15-flavored) | 12L/1T | **partial** |
