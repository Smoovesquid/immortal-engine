...
export default [
  ...
  },
  {
    ...
    diverge: [
      ...
      { text: 'what happened?', reason: '(W-7) bare, no place anchor → its own path, NOT poached by the events slot' },
      { text: 'what is this object?', reason: '(W-7) OBJECT-query → never answered by a place slot (deflect/decline, not the event)' },
    ],
    source: 'W-6 (NPC-dialogue renderer over the place-query resolver); reproduced LLM-off trade_town_tavern_dialogue',
  },
  {
    ...
    diverge: [
      ...
      { text: 'what is this object?', reason: '(W-7) OBJECT-query → never answered by the population roster (deflect/decline)' },
    ],
    source: 'W-6 (NPC-dialogue renderer over the place-query resolver); reproduced LLM-off trade_town_tavern_dialogue',
  },
  {
