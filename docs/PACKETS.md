...
### JR-HUNT-1 — the hunt can't catch you mid-fast-travel (journey returns before worldTick)  ·  Phase 0/4 seam  ·  **QUEUED 2026-07-06 (MP-3 worker's flagged finding — correct to leave; playloop was off its lane)**
...
- **Queued taste follow-up (NOT dispatched):** wild minis (trees/boulders) still authored-fixed — true-scale trees at plan zoom is a look call (a 40-ft oak fills the room view); decide before cutting. Combat-board minis have their own cell contract — untouched by design.
