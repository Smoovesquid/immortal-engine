...
**Supersedes:** The finite-arc framing in `_archive/VICTORY_LADDER_MVP_v1.md` and `_archive/CAMPAIGN_LIFECYCLE_SPEC_v1.md` (both archived 2026-06-24). Those docs remain as historical artifacts; when they conflict with this one, this one wins.
