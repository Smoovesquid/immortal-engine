...
### JR-HUNT-1 — the hunt can't catch you mid-fast-travel (journey returns before worldTick)  ·  Phase 0/4 seam  ·  **CUT + DISPATCHED 2026-07-06 (Basecamp, Tim's max-parallel directive; brief `briefs/JR-HUNT-1-roadside-reckoning.md`; U573–U574 claimed; the serial playloop slot — diagnose-first, no-double-tick wall, worldTick itself untouched/MP-4's)** *(was QUEUED same day — MP-3 worker's flagged finding)*
...
### OCC-STORY-2 — "up to something" becomes thread-driven  ·  Phase 1/4 seam  ·  **UNBLOCKED 2026-07-06 (OCC-STORY-1 landed b092; thread aging LIVE via CONSEQ-1 b106 — the substrate this packet reads; cut after MP-4 lands)** *(was: queued behind OCC-STORY-1)*
