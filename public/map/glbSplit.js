// glbSplit — split a fused Meshy "parts sheet" into individual pieces by geometry islands.
// (Live-map sibling of the map-proto/glbkit.js prototype.) A Meshy export that visually
// holds several separate objects is ONE mesh with ONE texture atlas, but the objects are
// disconnected geometry; connected-components over welded verts recovers them, each
// keeping its slice of the shared UV/texture. A cohesive building returns one big island.
//
// splitIslands(THREE, root, opts) → [{ geo, mat, size:Vector3, box:Box3, tris }] big→small.
