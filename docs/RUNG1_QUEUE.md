...
## Budget — **$29.82 (Tim, 2026-06-23) → Phase-A-boundary gate (`opus-gate-2026-06-23.md`, seed `tallow`) ~$2.77 → ~$27.05 remaining** (~9 runs at ~$2.80). Supersedes the stale $20/06-22 line below. Re-confirm before any run that would drop below ~$2.5.
