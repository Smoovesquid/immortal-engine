...
// ─────────────────────────────────────────────────────────────────────────────
test('U496: the finding classes are the MR-ORACLE classes (incl. MR-2a GEOMETRY_BREACH + MR-3a FEATURE_BLOCK + FURN-1 FURNITURE_BLOCK)', () => {
  assert.deepEqual(Object.keys(FINDING_CLASSES).sort(), ['FEATURE_BLOCK', 'FURNITURE_BLOCK', 'GEOMETRY_BREACH', 'POSITION_DESYNC', 'TOPOLOGY_BREACH']);
