...
- **Test:** same seed always produces same type for same node
...
- **Test:** wilderness node produces no buildings; settlement node produces at least 2
...
- **Test:** 3 moves north = `localFtY` of -90
...
- **Test:** enter → export → import → re-enter same structure = same `roomId`
...
- **Test:** move to adjacent room succeeds; move to non-adjacent room is rejected
...
- **Test:** replay 10 turns from same seed = identical `worldHash`
