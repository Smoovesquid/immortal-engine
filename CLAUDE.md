...
- `docs/IMMORTAL_INVARIANTS.md` — the non-negotiables (determinism, narration≠canon, one walkable scale, open-ended) **+ the DENIED list** (21–29: rule, never simulate — check it before scoping ANY new player freedom).
