...
| C2 | A **named referent** must be grounded before the turn resolves | H-56/C2-grad/H-60/H-79, **H-90** | `ungroundedNpcReferentForText` + `hasPersonReferentSignal` + observe/travel hoist + social-resolver guard + sentence-initial proper-name stopwords | 7L/0T | **✓** |
