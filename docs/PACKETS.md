...
**⏳ LANES IN FLIGHT 2026-07-06 ~17:0x (Basecamp dispatch):** both afternoon lanes HOME — PW-6 ✅ b123 · SP-3 ✅ b124 (U625–U627 committed; the allocator sees them again — **next free U628+, script trustworthy**). ENSURE-STATS-1 dispatching now (state/escapeCombat lane free; claims noted at its row when numbers are cut).
