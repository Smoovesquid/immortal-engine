...
test('U412-01: WORLD_VERSION is 32 (TAC-1 bumped to 30; MR-2a doors → 31; SP-2 faction ethos → 32)', () => {
...
test('U412-04: a pre-bump (v29) save loads with a warn and gains pos', () => {
  ...
  assert.ok(warnings.length > 0 && warnings[0].includes('v29') && warnings[0].includes('v32'),
