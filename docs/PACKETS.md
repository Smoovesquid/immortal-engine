...
### CONSEQ-1 — threads actually age (normalizeThread stops eating age/objective/trajectory)  ·  Phase 0/1 seam  ·  **DISPATCHED 2026-07-06 (Basecamp; inline brief = this row verbatim; U568–U569 claimed; sonnet worktree lane — instrument.js disjoint from MP-3's fence; unblocks OCC-STORY-2 cut)** *(was QUEUED 2026-07-05: found by the SL-5 lane; fix drafted + simulation-verified)*
